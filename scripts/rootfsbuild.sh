...
nhb_stage4(){
  ...
  cp -rf $maindir/utils/bin/mana/start-mana-full $kalirootfs/usr/bin/
  cp -rf $maindir/utils/bin/mana/start-mana-noup $kalirootfs/usr/bin/
  cp -rf $maindir/utils/bin/mana/start-mana-noupeap $kalirootfs/usr/bin/
  cp -rf $maindir/utils/bin/mana/start-mana-simple $kalirootfs/usr/bin/
  cp -rf $maindir/utils/bin/mana/stop-mana $kalirootfs/usr/bin/
  cp -rf $maindir/utils/bin/mana/start-nat-full-mod.sh $kalirootfs/usr/share/mana-toolkit/run-mana/
  cp -rf $maindir/utils/bin/mana/start-nat-simple-mod.sh $kalirootfs/usr/share/mana-toolkit/run-mana/
  cp -rf $maindir/utils/bin/mana/start-noupsream-eap-mod.sh $kalirootfs/usr/share/mana-toolkit/run-mana/
  cp -rf $maindir/utils/bin/mana/start-upstream-mod.sh $kalirootfs/usr/share/mana-toolkit/run-mana/
