...
nhb_stage1(){
  echo "\e[31m##########################################################################################\e[0m"
  echo "\e[31m###\e[0m  FIRST STAGE CHROOT  \e[31m#################################################################\e[0m"
  echo "\e[31m##########################################################################################\e[0m"

  echo -e "\e[31mCreating Kali chroot.\e[0m"
...
nhb_stage2(){
  ...
  echo -e "\e[31mCopying scripts to Kali /usr/bin.\e[0m"
  #### Install Local files
...
nhb_stage3(){
  echo "\e[31m##########################################################################################\e[0m"
  echo "\e[31m###\e[0m  THIRD STAGE CHROOT  \e[31m#################################################################\e[0m"
  echo "\e[31m##########################################################################################\e[0m"
  ...
  echo -e "\e[31mExecuting stage-three script.\e[0m"
...
nhb_stage4(){
  echo "\e[31m##########################################################################################\e[0m"
  echo "\e[31m###\e[0m  FOURTH STAGE CHROOT  \e[31m################################################################\e[0m"
  echo "\e[31m##########################################################################################\e[0m"

  echo -e "\e[31mModify Kismet files.\e[0m"
  ...
  echo -e "\e[31mCopying Mana files.\e[0m"
  ...
  echo -e "\e[31mInstalling Rawr.\e[0m"
  ...
  echo -e "\e[31mInstalling Spiderfoot.\e[0m"
  ### Install Spiderfoot
  ...
  echo -e "\e[31mInstalling ADB and fastboot.\e[0m"
  ...
  echo -e "\e[31mInstalling deADBolt.\e[0m"
  ### Installs deADBolt
  ...
  echo -e "\e[31mInstalling APFucker.py.\e[0m"
  ...
  echo -e "\e[31mInstalling HID attack script.\e[0m"
  ...
  echo -e "\e[31mCopying DNSMasq.conf.\e[0m"
  ...
  echo -e "\e[31mCreating extra directories for NetHunter.\e[0m"
  ...
  echo -e "\e[31mConfiguring Beef-xss.\e[0m"
...
nhb_clean(){
  echo "\e[31m##########################################################################################\e[0m"
  echo "\e[31m###\e[0m  CLEAN UP CHROOT  \e[31m####################################################################\e[0m"
  echo "\e[31m##########################################################################################\e[0m"

  echo -e "\e[31mRunning clean-up script.\e[0m"
  ### Run clean-up script
  ...
  echo -e "\e[31mUnmounting partitions.\e[0m"
  ### Unmount partitions
...
nhb_zip(){
  echo "\e[31m##########################################################################################\e[0m"
  echo "\e[31m###\e[0m  CREATING ZIP  \e[31m#######################################################################\e[0m"
  echo "\e[31m##########################################################################################\e[0m"

  echo -e "\e[31mCopying premade flashable directory.\e[0m"
  ...
  echo -e "\e[31mInstalling extra applications for Android.\e[0m"
